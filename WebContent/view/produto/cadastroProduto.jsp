...
<title>ELETROSTEC - Cadastro de Produtos</title>
        ...
        <div id="signupbox" style="margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form" method="post" action="incluirProduto" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="codigo" maxlength="4" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="fabricante" required="required">
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="lastname" class="col-md-3 control-label">Quantidade no Estoque</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="qtdEstoque" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="especificacao" required="required">
                                    </div>
                                    </div>
